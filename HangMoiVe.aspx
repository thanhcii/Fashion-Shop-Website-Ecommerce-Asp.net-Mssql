<%@ Page Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true" CodeBehind="HangMoiVe.aspx.cs" Inherits="DoAn4.WebForm11" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Con1" runat="server">
    ...
    <asp:Label ID="lblTieuDe" runat="server" Font-Bold="False" Font-Names="Arial" 
        Font-Size="Large" ForeColor="#333333">Quần áo mới về</asp:Label>
    </div>
